...
{
    public class ViewModelEM4152SensorDataStored : BaseViewModel
    {
        ...
        public ViewModelEM4152SensorDataStored(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
