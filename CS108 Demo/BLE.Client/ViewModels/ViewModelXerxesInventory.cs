...
{
    public class ViewModelXerxesInventory : BaseViewModel
	{
        ...
        public ViewModelXerxesInventory(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
        ...
        void InventorySetting()
        {
            ...
            else
            {
                ...
                extraSlecetion.mask = new CSLibrary.Structures.SelectMask(CSLibrary.Constants.MemoryBank.TID, 0, 28, new byte[] { 0xE2, 0x82, 0x40, 0x50 });
                BleMvxApplication._reader.rfid.SetSelectCriteria(1, extraSlecetion);
            }
