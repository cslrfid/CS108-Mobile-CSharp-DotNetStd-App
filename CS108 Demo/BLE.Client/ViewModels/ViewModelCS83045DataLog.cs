...
{
    public class ViewModelCS83045DataLog : BaseViewModel
    {
        public class ColdChainTagInfoViewModel : BindableBase
        {
            ...
            public string DateTime { get { return this._DateTime; } set { this.SetProperty(ref this._DateTime, value); } }
        ...
        public ViewModelCS83045DataLog(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
            _userDialogs = userDialogs;

            RaisePropertyChanged(() => ListViewRowHeight);

            OnOKButtonCommand = new Command(OKClick);
        }

        ~ViewModelCS83045DataLog()
        {
        }
