...
{
    public class ViewModelEM4152SensorControlWord1 : BaseViewModel
    {
        ...
        public ViewModelEM4152SensorControlWord1(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
