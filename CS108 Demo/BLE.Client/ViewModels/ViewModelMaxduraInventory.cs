...
{
    public class ViewModelMacduraInventory : BaseViewModel
    {
        public class MacduraTagInfoViewModel : BindableBase
        {
            private string _EPC;
        ...
        private ObservableCollection<MacduraTagInfoViewModel> _TagInfoList = new ObservableCollection<MacduraTagInfoViewModel>();
        public ObservableCollection<MacduraTagInfoViewModel> TagInfoList { get { return _TagInfoList; } set { SetProperty(ref _TagInfoList, value); } }
        ...
        public ViewModelMacduraInventory(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
