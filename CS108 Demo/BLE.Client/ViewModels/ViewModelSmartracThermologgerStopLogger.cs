...
{
    public class ViewModelSmartracThermologgerStopLogger : BaseViewModel
    {
        ...
        public ViewModelSmartracThermologgerStopLogger(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
        ...
        void SendReadSystemInformation ()
        {
            ...
            BleMvxApplication._reader.rfid.Options.TagWriteUser.pData = new ushort[1] { (0x8800 | 0x120) };
