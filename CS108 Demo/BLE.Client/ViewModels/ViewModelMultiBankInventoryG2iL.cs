...
namespace BLE.Client.ViewModels
{
    ...
    public class TagInfoG2iLViewModel : BindableBase
    {
        private string _EPC;
        ...
        private string _IsTamperedColor;
        public string IsTamperedColor { get { return this._IsTamperedColor; } }
        public string IsTampered
        {
            get
            {
                if (this._Bank1Data.Length == 4 && System.Text.RegularExpressions.Regex.IsMatch(this._Bank1Data, @"\A\b[0-9a-fA-F]+\b\Z"))
                {
                    int configWord = int.Parse(this._Bank1Data, System.Globalization.NumberStyles.HexNumber);
                    if (((configWord & 0x8000) >> 15) == 1)
                    {
                        _IsTamperedColor = "Green";
                        return "OK";
                    }
                    else
                    {
                        _IsTamperedColor = "Red";
                        return "TAMPERED";
                    }
                }
                else
                {
                    _IsTamperedColor = "Black";
                    return "UNKNOWN";
                }
            }
        }
        ...
        public TagInfoG2iLViewModel()
        {
        }
    }

    public class ViewModelMultiBankInventoryG2iL : BaseViewModel
	{
		...
		private ObservableCollection<TagInfoG2iLViewModel> _TagInfoList = new ObservableCollection<TagInfoG2iLViewModel>();
		public ObservableCollection<TagInfoG2iLViewModel> TagInfoList { get { return _TagInfoList; } set { SetProperty(ref _TagInfoList, value); } }
        ...
        public ViewModelMultiBankInventoryG2iL(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
        ...
        ~ViewModelMultiBankInventoryG2iL()
        {
        ...
        void InventorySetting()
        {
            ...
            // Read config word of G2iL+
            BleMvxApplication._reader.rfid.Options.TagRanging.multibanks = 1;
            BleMvxApplication._reader.rfid.Options.TagRanging.bank1 = CSLibrary.Constants.MemoryBank.BANK1;
            BleMvxApplication._reader.rfid.Options.TagRanging.offset1 = 32;
        ...
        private void AddOrUpdateTagData(CSLibrary.Structures.TagCallbackInfo info)
        {
            InvokeOnMainThread(() =>
            {
                ...
                lock (TagInfoList)
                {
                    ...
                    if (!found)
                    {
                        TagInfoG2iLViewModel item = new TagInfoG2iLViewModel();
